...
class HitungZakatHasilTambang extends StatefulWidget {
  @override
  _HitungZakatHasilTambangState createState() =>
      _HitungZakatHasilTambangState();
}
...
class _HitungZakatHasilTambangState extends State<HitungZakatHasilTambang> {
  ...
  TextEditingController controllerJumlahTambang = TextEditingController(text: '');
  TextEditingController controllerTambang = TextEditingController(text: '');
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () {
                      setState(() {
                        ...
                        if (pilihTambang == "Emas" ||
                            pilihTambang == "Batuan" ||
                            pilihTambang == "Minyak" ||
                            pilihTambang == "Lainnya") {
                ...
                jumlahZakat == 0
                    ...
                    : Container(
                        ...
                        decoration: BoxDecoration(
                            color: Color(0xFF56A74D),
                            borderRadius: BorderRadius.circular(10)),
                        child: jumlahTambang > nisab
                            ? Text(
                                'Zakat Hasil Tambang yang harus anda keluarkan sebesar $zakat',
                                style: TextStyle(
                                    fontFamily: 'montserrat',
                                    fontSize: 15,
                                    color: Colors.white),
                            ...
                            : Text(
                                'Harta anda belum memenuhi nisab zakat Hasil Tambang',
                                style: TextStyle(
                                    fontFamily: 'montserrat',
                                    fontSize: 15,
                                    color: Colors.white),
