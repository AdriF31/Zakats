...
class _HitungZakatPerniagaanState extends State<HitungZakatPerniagaan> {
  ...
  TextEditingController controllerJumlahUang = TextEditingController(text: '');

  TextEditingController controllerJumlahHutang = TextEditingController(text: '');
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        "nisab untuk zakat perniagaan yaitu sebesar 85 gram emas\nzakat yang dikeluarkan adalah sebesar 2,5%",
                        style:
                ...
                nishab == 0
                    ...
                    : Container(
                        ...
                        decoration: BoxDecoration(
                            color: Color(0xFF56A74D),
                            borderRadius: BorderRadius.circular(10)),
                        child: nishab < 85 * 837000
                            ? Text(
                                "Harta anda belum memenuhi nisab zakat perniagaan, anda tidak wajib mengeluarkan zakat",
                                style: TextStyle(
                                    fontFamily: 'montserrat',
                                    fontSize: 15,
                                    color: Colors.white),
                            ...
                            : Text(
                                'Anda sudah memenuhi nisab zakat perniagaan, zakat yang harus anda keluarkan sebesar $zakat',
                                style: TextStyle(
                                    fontFamily: 'montserrat',
                                    fontSize: 15,
                                    color: Colors.white),
