...
class _HitungZakatHewanTernakState extends State<HitungZakatHewanTernak> {
  ...
  TextEditingController controllerJumlahHewan = TextEditingController(text: '');
  TextEditingController controllerHewan = TextEditingController(text: '');
                      ...
                      setState(() {
                        ...
                        if (pilihHewan == "Domba") {
                          ...
                          if (jumlahHewan < 5) {
                            ...
                            jumlahZakat = 1;
                            hewan =
                                "Kambing (2 tahun) atau $jumlahZakat ekor Domba (1 tahun)";
                ...
                jumlahZakat == 0
                    ...
                    : Container(
                        ...
                        decoration: BoxDecoration(
                            color: Color(0xFF56A74D),
                            borderRadius: BorderRadius.circular(10)),
                        child: jumlahHewan >= nisab
                            ? Text(
                                'Zakat Hewan Ternak yang harus anda keluarkan adalah sebanyak $jumlahZakat ekor $hewan',
                                style: TextStyle(
                                    fontFamily: 'montserrat',
                                    fontSize: 15,
                                    color: Colors.white),
                            ...
                            : Text(
                                'Harta anda belum memenuhi nisab zakat Hewan Ternak',
                                style: TextStyle(
                                    fontFamily: 'montserrat',
                                    fontSize: 15,
                                    color: Colors.white),
