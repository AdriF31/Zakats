...
class _HitungEmasState extends State<HitungEmas> {
  ...
  TextEditingController controllerJumlahEmasDipakai =
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
        ...
        builder: (context, snapshot) {
          ...
          DateTime tanggal =
              snapshot.data.documents[0].data['lastUpdated'].toDate();
                  ...
                  children: <Widget>[
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: () {
                          setState(() {
                            ...
                            jumlahEmasDipakai =
                                int.parse(controllerJumlahEmasDipakai.text);
                    ...
                    nishab == 0
                        ...
                        : Container(
                            ...
                            child: nishab < 85
                                ? Text(
                                    "Harta anda belum memenuhi nishab zakat emas, anda tidak wajib mengeluarkan zakat",
                                    style: TextStyle(
                                        fontFamily: 'montserrat',
                                        fontSize: 15,
                                        color: Colors.white),
                                ...
                                : Text(
                                    'Anda sudah memenuhi nisab zakat emas, zakat yang harus anda keluarkan sebesar $zakat',
                                    style: TextStyle(
                                        fontFamily: 'montserrat',
                                        fontSize: 15,
                                        color: Colors.white),
