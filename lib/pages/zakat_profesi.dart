...
class _HitungZakatProfesiState extends State<HitungZakatProfesi> {
  ...
  TextEditingController controllerPengeluaran = new TextEditingController(text: '');
  TextEditingController controllerPenghasilan = new TextEditingController(text: '');

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("ZAKAT PROFESI", style: TextStyle(fontFamily: 'montserrat', fontWeight: FontWeight.bold),),
        centerTitle: true,
      ),
            ...
            child: Column(
              children: <Widget>[
                ...
                Container(
                    ...
                    child:
                    nishab<520*10000? Text("Harta anda belum memenuhi nisab zakat profesi, anda tidak wajib mengeluarkan zakat",style:TextStyle(fontFamily: 'montserrat',fontSize: 15,color: Colors.white),textAlign: TextAlign.justify,)
                        : Text('Anda sudah memenuhi nisab zakat profesi, zakat yang harus anda keluarkan sebesar $zakat',style: TextStyle(fontFamily: 'montserrat',fontSize: 15,color: Colors.white),textAlign: TextAlign.justify,)
