  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
        ...
        builder: (context, snapshot){
          ...
          DateTime tanggal = snapshot.data.documents[0].data['lastUpdate'].toDate();
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Container(
                        ...
                        child:
                        nishab<595? Text("Harta anda belum memenuhi nishab zakat perak, anda tidak wajib mengeluarkan zakat perak",style: TextStyle(fontFamily: 'montserrat',fontSize: 15,color: Colors.white),textAlign: TextAlign.justify,)
