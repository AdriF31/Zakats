...
class _HitungZakatPertanianState extends State<HitungZakatPertanian> {
  ...
  TextEditingController controllerJumlahPanen = new TextEditingController(text: '');
  TextEditingController controllerPengairan = new TextEditingController(text: '');
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("ZAKAT HASIL PERTANIAN", style: TextStyle(fontFamily: 'montserrat', fontWeight: FontWeight.bold),),
        centerTitle: true,
      ),
            ...
            child: Column(
              children: <Widget>[
                ...
                Container(
                    ...
                    child: jumlahPanen>750? Text('Zakat harta temuan yang harus anda keluarkan sebesar $jumlahZakat Kg',style: TextStyle(fontFamily: 'montserrat',fontSize: 15,color: Colors.white),textAlign: TextAlign.justify,)
                        : Text('Harta anda belum memenuhi nisab zakat hasil pertanian',style: TextStyle(fontFamily: 'montserrat',fontSize: 15,color: Colors.white),textAlign: TextAlign.justify,)
                )
              ],
            ),
          ),
